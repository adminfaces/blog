...
This release brings scaffold for AdminFaces application via https://forge.jboss.org/[JBoss Forge^]. Forge can be used on your favorite IDE as well integrated on the command line of your via cli on your preferred operating system.
